...
namespace LetsGetOrganizedWPF
{
    public partial class OptionsStep1Control : UserControl
    {
        ...
        private void AllExtensionsRadio_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            if(CustomExtensionsPanel != null){
                CustomExtensionsPanel.Visibility = System.Windows.Visibility.Collapsed;
        ...
        private void CustomExtensionsRadio_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            CustomExtensionsPanel.Visibility = System.Windows.Visibility.Visible;
        ...
        // checkbox handlers
        private void HiddenCheckbox_Checked(object sender, System.Windows.RoutedEventArgs e) => includeHiddenFiles = true;
        private void HiddenCheckbox_Unchecked(object sender, System.Windows.RoutedEventArgs e) => includeHiddenFiles = false;

        private void SubfoldersCheckbox_Checked(object sender, System.Windows.RoutedEventArgs e) => includeSubfolders = true;
        private void SubfoldersCheckbox_Unchecked(object sender, System.Windows.RoutedEventArgs e) => includeSubfolders = false;
